                ...
                <div className="info">
                    ...
                    <div className="sections row">
                        <div className='col-lg-3 col-md-6 col-12'>
                            ...
                            <div className="desc">Twoje oprogramowanie będzie nie tylko intuicyjne, ale także wydajne. Dzięki naszym aplikacjom desktopowym osiągniesz nowy poziom efektywności i kontroli nad działaniem Twojego biznesu.</div>
                        </div>
                        <div className='col-lg-3 col-md-6 col-12'>
